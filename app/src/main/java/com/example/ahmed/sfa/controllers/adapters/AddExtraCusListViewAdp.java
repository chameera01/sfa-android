...
public class AddExtraCusListViewAdp extends BaseAdapter{
    ...
    public AddExtraCusListViewAdp(Activity activity,ArrayList<HashMap<String, String>> list){
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView=inflater.inflate(R.layout.addextr_lv_row, null);
            holder=new ViewHolder();

            holder.txtFirst=(CheckBox) convertView.findViewById(R.id.addexCus_cb);
            holder.txtSecond=(TextView) convertView.findViewById(R.id.addexCus_name);
            holder.txtThird=(TextView) convertView.findViewById(R.id.addexCus_add);
            holder.txtFourth=(TextView) convertView.findViewById(R.id.addexCus_twn);
            holder.txtFifth=(TextView) convertView.findViewById(R.id.addexCus_tel);
